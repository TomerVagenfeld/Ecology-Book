...
import os
import regex as re
from settings import MEDIA_SOURCE_DIR, MEDIA_REL_PATH, figure_label_pattern,desc_block_pattern,figure_pattern, img_bloc_and_height_pattern, image_file_pattern
...
#     input = r"H:\My Drive\work\EcologyDotCom\test_doc_to_md\word_header_python\ch7.md"
#     output_after = r"H:\My Drive\work\EcologyDotCom\test_doc_to_md\Ecology-Book\output_after.md"
#     main(input, output_after)

if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python insert_img_to_md.py input.md output.md")
    else:
